      ...
      <div class="wrapper fadeInDown">
              <div id="formContent">
                ...
                <div class="fadeIn first">
                  <img src="@/assets/logo-calc.png" id="icon" alt="User Icon" />
                </div>

                <!-- Login Form -->
                <form v-on:submit.prevent="login">
                  <input type="text" id="login" class="fadeIn second" name="login" placeholder="User" v-model="username">
...
export default {
  ...
  methods:{
    async login(){
        ...
        try{
        await this.axios.post(this.$API_URL+'/auth', payload)
        .then( data =>{
...
input[type=text]:placeholder,input[type=placeholder] {
  color: #cccccc;
}
/* ANIMATIONS */
